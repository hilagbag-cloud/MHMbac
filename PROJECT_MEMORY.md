...
| Dernier commit confirmé | `0426632` — pages publiques, navigation et portail partenaire |
...
| 15 août 2026 | Prêt à publier | Logos des headers principal et partenaire corrigés : hauteur de navigation fixe, largeur automatique et `object-contain` afin de préserver le ratio source. Compilation TypeScript et build Vite validés. | Déployer et vérifier visuellement les deux headers HTTPS. |
