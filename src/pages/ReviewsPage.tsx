...
export default function ReviewsPage({ navigate }: { navigate: (route: string) => void }) {
  ...
  const submit = async (event: FormEvent) => {
    ...
    try {
      ...
      setTitle('');
      setBody('');
      setNotice('Merci. Ton avis est reçu et sera publié seulement après vérification, avec ton accord.');
    } catch (error) {
