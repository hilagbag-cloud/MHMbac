  ...
  const save = async (status = publicationStatus) => {
    ...
    try {
      ...
      if (status === 'withdrawn') {
        ...
        setMessage({ type: 'success', text: 'Ta fiche individuelle est publiée. Les moteurs de recherche peuvent ensuite la découvrir progressivement ; BacPilot ne promet pas de position.' });
